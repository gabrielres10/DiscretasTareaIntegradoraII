...
public class EditPersonWindow implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		nameTF.setText(personToEdit.getName());
		lastNameTF.setText(personToEdit.getLastName());
		genderCB.setValue(personToEdit.getGender());
		nationalityCB.setValue(personToEdit.getNationality());
		heightTF.setText(""+personToEdit.getHeight());
	}
}