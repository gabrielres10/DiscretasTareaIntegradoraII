...
public class SearchWindow implements Initializable {
	...
	void launchEditPerson(ActionEvent event) {
		...
		EditPersonWindow.personToEdit = coincidencesTable.getSelectionModel().getSelectedItem();
	...
	public void launchCreatePersonWindow(ActionEvent event) throws IOException {
		FXMLLoader loader = new FXMLLoader(AmericaDataBase.class.getResource("../view/CreatePersonWindow.fxml"));
